...
export default function BorderDevPage() {
  ...
  const selectGuide = (index: number) => { setSelected(index); if (index === 1) setOptions(current => ({ ...current, leafSize: 46, pitch: 30 })); };
