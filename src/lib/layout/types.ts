...
export type ShapeElement = ElementBase & { type: 'shape'; settings: ShapeSettings };
export type PlaceholderElement = ElementBase & { type: 'calligram' | 'curved-title' };
...
export function isProportional(element:LayoutElement){return element.type==='calligram'||element.type==='curved-title'||element.type==='shape'&&isConstrainedShape(element.settings);}
