...
export default function LayoutInspector({ element, page, textFitPlan, onChange }: { element: LayoutElement; page: PageElement; textFitPlan: GuidelinesTextFitPlan | null; onChange: (element: LayoutElement) => void }) {
